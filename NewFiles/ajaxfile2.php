...
INNER JOIN tb_user ON tb_user_track.Username=tb_user.Username WHERE 1 ".$searchQuery." AND tb_user_track.Username='".$_SESSION['Username']."' order by ".$columnName." ".$columnSortOrder." limit ".$row.",".$rowperpage;
