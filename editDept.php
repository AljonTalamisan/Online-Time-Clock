...
if(isset($_POST['update'])) // when click on Update button
{
    ...
    $edit = "update tb_user_track set Username='$Username', Department='$Comp_Name', Date='$Date', Time_Out='$Time_In', Time_Out='$Time_Out' where Track_ID='$id'";
    ...
    if($resultedit)
    {
		if($resultcalc)
		{
        header("location:DEPTdashboard.php"); // redirects to all records page
        exit;
		}
    }
    else
...
<form method="POST">
  ...
  <input type="text" name="Department" value="<?php echo $data['Department'] ?>" placeholder="Enter Deparmtment Name" Required>
  ...
  <a href="DEPTDashboard.php" class="ui blue button submit">BACK</a>
</form>
</div>
