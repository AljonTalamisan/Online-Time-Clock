...
$comp = "SELECT User_ID,EmployeeNo, FirstName, MiddleName, LastName, Department, Username, Usertype from tb_user where Department = '$compname' OR NOT EXISTS(
        SELECT User_ID,EmployeeNo, FirstName, MiddleName, LastName, Department, Username, Usertype
        FROM tb_user
